...
class CommandsTab(QWidget):
    ...
    def init_ui(self):
        ...
        tip_label = QLabel(
            ...
            "/clear (erase history) • "
            "/config (settings) • "
            "/usage (plan usage; /cost is an alias) • "
            "/context (context window map) • "
            ...
            "Optional frontmatter: <code>allowed-tools</code>, <code>argument-hint</code>, "
            "<code>description</code>, <code>model</code>, <code>disable-model-invocation</code>"

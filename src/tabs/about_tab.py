...
class AboutTab(QWidget):
    ...
    def load_links(self):
        ...
        self.official_links = [
            ...
            ["https://code.claude.com/docs/en/settings-reference", "Settings Reference (all keys)"],
            ["https://code.claude.com/docs/en/memory", "Memory System"],
            ["https://code.claude.com/docs/en/checkpointing", "Checkpointing"],
            ["https://code.claude.com/docs/en/commands", "Built-in Commands"],
            ...
            ["https://code.claude.com/docs/en/agent-sdk/skills", "Agent SDK Skills"],
        ]
